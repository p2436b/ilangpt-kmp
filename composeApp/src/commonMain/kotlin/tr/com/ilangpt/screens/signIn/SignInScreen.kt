...
private fun SignInContent() {
  ...
  Column(modifier = Modifier.fillMaxSize().padding(horizontal = 16.dp)) {
    ...
    AppButton(modifier = Modifier.fillMaxWidth(), onClick = { navigator?.push(HomeScreen()) }) {
      Image(
    ...
    AppButton(modifier = Modifier.fillMaxWidth(), onClick = { navigator?.push(HomeScreen()) }) {
      Image(painter = painterResource(Res.drawable.apple_logo), contentDescription = "Apple logo")
      Spacer(modifier = Modifier.width(8.dp))
